...
./complete_codes/gpu_mem    VBO와 IBO를 이용한 렌더링 버전
...
# 주의사항
complete_codes/ 폴더 아래의 코드를 예제로 돌려보려면 아래와 같이 현재 디렉토디의 main.cpp에 덮어쓴 다음 make를 수행하고 실행하세요. (* 소스코드가 ./glsl/ 폴더 아래의 쉐이더 코드를 참조하도록 작성되었기 때문입니다.) 
